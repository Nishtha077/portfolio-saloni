...
const achievements = [
  {
    ...
    type: "image",
    description:
      "Researched cases of 'Fishing' fraud, where individuals use duplicate Aadhaar numbers for identity verification. Explored techniques such as facial recognition, liveness detection, and AI-driven anomaly detection to prevent misuse.",
  },
  {
    file: days,
